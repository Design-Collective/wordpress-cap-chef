...
?>
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <a href="#addcomments" class="link-add-comment anchor"><?php _e('POST YOUR REPLY', 'tfuse') ?></a>
        <ol>
            <?php
...
$args = array(
    ...
    'label_submit'      => __( 'ADD YOUR COMMENT','tfuse'  ),

    'comment_field' => ' <div class="row">
							<label class="label_title"><strong>'.__('Message','tfuse').'</strong></label>
    ...
    'fields' => apply_filters( 'comment_form_default_fields', array(
            ...
            'author' =>'<div class="row alignleft field_text">
							...
							<input type="text" name="author" class="inputtext required" id="name" value="' . esc_attr( $commenter['comment_author'] ) .'" tabindex="1" ' . $aria_req . '/>
						</div>',

            'email' =>'<div class="row alignleft field_text omega">
							<label class="label_title"><strong>'.__('Email','tfuse').'</strong></label>
