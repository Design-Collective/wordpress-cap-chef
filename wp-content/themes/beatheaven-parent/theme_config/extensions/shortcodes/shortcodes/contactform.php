...
function tf_contactform_shortcode($atts){
    ...
    if($form_exists){
        $out.=' <div class="add-comment" id="addcomments">';
        ...
        $out.='<button id="sending" class="btn btn-primary btn-lg btn-send2" style="display: none;"><span class="icon icon-plus-sign"></span>'.__('Sending ...','tfuse').'</button>
            <button type="submit" id="send_form" class="btn btn-primary btn-lg btn-submit2" name="submit" ><span class="icon icon-plus-sign"></span>'. urldecode($form['submit_mess']).'</button>
