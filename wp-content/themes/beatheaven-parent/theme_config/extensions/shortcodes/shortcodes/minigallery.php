...
function tfuse_minigallery($attr, $content = null)
{
    ...
    $out = '<h2 class="shortcode_title">'.$title.'</h2>
    <div class="minigallery_carousel">
        ...
        <a class="prev" id="minigallery'.$uniq.'_prev" href="#"><span class="icon icon-chevron-left"></span></a>
        <a class="next" id="minigallery'.$uniq.'_next" href="#"><span class="icon icon-chevron-right"></span></a>
    </div>';
    $out .= ' <script>
