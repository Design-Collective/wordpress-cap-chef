...
class TFuse_Widget_Search extends WP_Widget {
	...
	function widget($args, $instance) { 
			...
			<div class="widget-container widget_search">
                            <h3 class="widget-title"><span class="icon icon-rss-sign"></span><?php echo $title; ?></h3>
                            <form method="get" id="searchform" action="<?php echo home_url( '/' ) ?>">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm"><span class="icon icon-search"></span></button>
                            </form>
			</div>
			<?php
        }
