...
class TFuse_Widget_Contact extends WP_Widget
{
    ...
    function widget( $args, $instance )
    {
        ...
        if ( $instance['phone'] != '')
        {
            echo '<div class="info_row"><span class="info_icon"><span class="icon icon-phone"></span></span>'.tfuse_qtranslate($instance['phone']).
                '</div>';
        }
        if ( $instance['fax'] != '')
        {
            echo '<div class="info_row"><span class="info_icon"><span class="icon icon-print"></span></span>'.tfuse_qtranslate($instance['fax']).
                '</div>';
        }
        
        if ( $instance['email_1'] != '')
        {
           echo '<div class="info_row"><span class="info_icon"><span class="icon icon-envelope"></span></span>
        ...
        {
            echo '<div class="info_row"><span class="info_icon"><span class="icon icon-facebook"></span></span><a href="http://'.tfuse_qtranslate($instance['facebook']).'" target="_blank">'.tfuse_qtranslate($instance['facebook']).'</a>
                </div>';
        }
        if ( $instance['twitter'] != '')
        {
            echo '<div class="info_row"><span class="info_icon"><span class="icon icon-twitter"></span></span><a href="http://'.tfuse_qtranslate($instance['twitter']).'" target="_blank">'.tfuse_qtranslate($instance['twitter']).'</a>
                </div>';
        }
