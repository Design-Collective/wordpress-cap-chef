...
$options = array(
    ...
    /* ----------------------------------------------------------------------------------- */
    /* Content Options */
    array('name' => __('Event Options','tfuse'),
        'id' => TF_THEME_PREFIX . '_event_option',
        'type' => 'metabox',
        'context' => 'normal'
    ),
    array('name' => __('Description','tfuse'),
        'desc' => __('Enter short description.','tfuse'),
        'id' => TF_THEME_PREFIX . '_short_desc',
        'value' => '',
        'type' => 'text',
        'divider'=>true
    ),
    array('name' => __('Ticket Price','tfuse'),
        'desc' => __('Ticket price From.','tfuse'),
        'id' => TF_THEME_PREFIX . '_ticket_price',
        'value' => '',
        'type' => 'text',
        'divider'=>true
    ),
    array('name' => __('Begining Date','tfuse'),
        'desc' => __('Select event\'s begining date.','tfuse'),
        'id' => TF_THEME_PREFIX . '_date_from',
        'value' => '',
        'type' => 'datepicker'
    ),
    array('name' => __('Final Date','tfuse'),
        'desc' => __('Select event\'s final date.','tfuse'),
        'id' => TF_THEME_PREFIX . '_date_final',
        'value' => '',
        'type' => 'datepicker'
    ),
    /* Post Media */
    ...
    array('name' => __('Event Type','tfuse'),
            'desc' => __('Select Event type.','tfuse'),
	...
	array('name' => __('Location','tfuse'),
        'id' => TF_THEME_PREFIX . '_content_location',
        'type' => 'metabox',
        'context' => 'normal'
    ),
	array('name' => __('Longitude','tfuse'),
    'desc' => __('Set the longitude.','tfuse'),
    'id' => TF_THEME_PREFIX . '_event_longitude',
    'value' => '',
    'type' => 'text'
	),
	array('name' => __('Latitude','tfuse'),
		'desc' => __('Set the latitude.','tfuse'),
		'id' => TF_THEME_PREFIX . '_event_latitude',
		'value' => '',
		'type' => 'text'
	),
);
