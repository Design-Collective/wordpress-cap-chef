...
$options = array(
    ...
    array('name' => __('Product Link', 'tfuse'),
        'desc' => __('Link to product.', 'tfuse'),
        'id' => TF_THEME_PREFIX . '_product_link',
        'value' => '',
        'type' => 'text',
        'divider' => true
    ),
    array('name' => __('Product Type','tfuse'),
            'desc' => __('Select Product type.','tfuse'),
