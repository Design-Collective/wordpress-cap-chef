...
$options = array(
    array('name' => __('Title','tfuse'),
        'desc' => __('Give a title for category .','tfuse'),
        'id' => TF_THEME_PREFIX . '_categ_title',
        'value' => '',
        'type' => 'text'
    ),
    array(
    ...
    array(
        'name' => __('Category Search','tfuse'),
        'desc' => __('Enable category search.','tfuse'),
        'id' => TF_THEME_PREFIX . '_category_search',
        'value' => 'true',
        'type' => 'checkbox'
    ),
     // Element of Hedear
